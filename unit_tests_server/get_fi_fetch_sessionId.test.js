...
describe('GET /FI/fetch/{sessionId} API Tests', () => {
    // this.timeout(50000);
// eslint-disable-next-line no-undef
    it('Scenario 1: Should return FI data for a valid sessionId and store it in the database', (done) => {
        const validSessionId = ''; // Replace with a valid sessionId

        chai.request(api_url)
            .get(`/FI/fetch/${validSessionId}`)
            .end((err, res) => {
